        ...
        <>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 w-full'>
                <div className='flex flex-col w-full font-raleway text-lg'>
                    Using Polygon API requires authorization. To authorize, you will need an API key, which can be generated on settings page at<br></br><Link href="https://polygon.codeforces.com/" className='text-blue-600'>https://polygon.codeforces.com/</Link>
                </div>
