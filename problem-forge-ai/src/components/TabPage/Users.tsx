...
const Users = ({ user, setUser, apiKey, setApiKey, secret, setSecret }: Props) => {
    return (
        <>
            ...
            <input value={user} onChange={(e) => { setUser(e.target.value) }} className="text-sm px-[1.5px] border-[1px] border-gray-600 rounded-[2px] w-2/5 font-mono resize-none"></input> */}
            <div className='grid grid-cols-1 lg:grid-cols-2 w-full'>
                <div className='flex flex-col w-full font-raleway text-lg'>
                    Using Polygon API requires authorization. To authorize, you will need an API key, which can be generated on settings page at<br></br><Link href="https://polygon.codeforces.com" target="_blank" className='text-blue-600' >https://polygon.codeforces.com</Link>
                </div>
