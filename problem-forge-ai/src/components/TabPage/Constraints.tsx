...
const Constraints = ({ error1, setError1, error2, setError2, timeLimit, setTimeLimit, memoryLimit, setMemoryLimit }: Props) => {
            ...
            <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                ...
                <div className="mb-4">
                    ...
                    <div className="flex items-center">
                        <input value={timeLimit} onChange={(e) => {
                    ...
                    {error1 && (
                        <p className="text-red-600 text-xs italic">{error1}</p>
                    )}
                    <p className="text-gray-600 text-xs italic">Time limit per test (between 250 ms and 15000 ms)</p>
                </div>
                ...
                <div className="mb-4">
                    ...
                    <div className="flex items-center">
                        <input value={memoryLimit} onChange={(e) => {
                            if (e.currentTarget.value === "") e.currentTarget.value = "0";
                            const num = parseInt(e.currentTarget.value);
                            if (!(4 <= num && num <= 1024)) {
                    ...
                    {error2 && (
                        <p className="text-red-600 text-xs italic">{error2}</p>
                    )}
                    <p className="text-gray-600 text-xs italic">Memory limit (between 4 MB and 1024 MB)</p>
                </div>
            </form>
        </div>
    )
