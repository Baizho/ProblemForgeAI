    ...
    return (
        <>
            <div className="z-10 flex flex-col items-center min-h-screen py-12 bg-gray-100">
                ...
                <p className="z-10 text-gray-600 text-xs lg:text-sm xl:text-lg text-center mb-6 font-raleway">
                ...
                <form className="flex flex-col items-center w-full px-6" onSubmit={handleSubmit}>
                    <div className="flex flex-col items-center justify-center lg:flex-row lg:items-center  w-full space-y-4 lg:space-y-0 lg:space-x-4 mb-4">
                        <div className='flex flex-col items-center md:flex-row md:justify-center md:space-x-4 w-full'>
                            ...
                            <div className="flex flex-col w-full md:w-2/4 m-4">
                                <label htmlFor="problemLevel" className="font-semibold font-raleway">Problem Idea</label>
                        ...
                        <div className='flex flex-col items-center md:flex-row md:justify-center md:space-x-4 w-full'>
                            <div className="flex flex-col w-full md:w-2/4 m-4 ">
                                <label htmlFor="problemLevel" className="font-semibold font-raleway">Problem Topic</label>
                    ...
                    <button
                        type="submit"
                        className="z-10 max-w-[200px] px-8 py-2 bg-blue-600 text-white font-raleway font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-75"
                    >
                        Generate
                    </button>
                </form>
