...
const TagsDropdown = ({ selectedTags, setSelectedTags, isTagsDropdownOpen, setIsTagsDropdownOpen }: Props) => {
    ...
    return (
        <>
            <div className="relative inline-block w-full xl:w-1/4 md:w-1/2 pl-2 mb-4 font-raleway z-[60]  ">
                    ...
                    <AnimatePresence>
                        {isTagsDropdownOpen && (
                            <motion.div
                                ...
                                className="absolute top-full mt-2 w-full bg-white border rounded shadow-lg z-[60] overflow-hidden"
                            >
                                <input
                                    type="text"
